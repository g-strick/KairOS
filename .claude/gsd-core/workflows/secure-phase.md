...
```
Agent(
  prompt="Read /Users/graysonstricker/Programs/KairOS/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/templates/SECURITY.md`
