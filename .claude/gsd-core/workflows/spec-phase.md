...
ones). Reference: @/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/graysonstricker/Programs/KairOS/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/graysonstricker/Programs/KairOS/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/templates/spec.md.
