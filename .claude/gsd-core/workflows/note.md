...
- **Global scope**: `/Users/graysonstricker/Programs/KairOS/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/graysonstricker/Programs/KairOS/.claude/notes/`)
...
2. Glob `/Users/graysonstricker/Programs/KairOS/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/graysonstricker/Programs/KairOS/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/graysonstricker/Programs/KairOS/.claude/notes/` — works in any directory
