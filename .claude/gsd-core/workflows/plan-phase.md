...
@/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/ui-brand.md
@/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/revision-loop.md
@/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/gate-prompts.md
...
- Planner is instructed to produce `SKELETON.md` in the phase directory alongside `PLAN.md`. The template lives at `/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/skeleton-template.md` — the planner reads it when producing SKELETON.md (lazy; not loaded on non-skeleton runs).
...
**If found:**
1. Read template: `/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/templates/VALIDATION.md`
...
**MVP_MODE:** ${MVP_MODE} (when true, follow vertical-slice rules from `/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/planner-mvp-mode.md`; when false, ignore MVP guidance entirely.)
**WALKING_SKELETON:** ${WALKING_SKELETON} (when true, the first deliverable must be a Walking Skeleton — Read the template at `/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/skeleton-template.md` and produce SKELETON.md alongside PLAN.md.)
**Granularity:** {granularity}

${MVP_MODE === 'true' ? `
<mvp_mode_active>
**MVP Mode is ENABLED.** Read `/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/planner-mvp-mode.md` now and follow its vertical-slice planning rules. Each plan must deliver a complete vertical slice — thin end-to-end functionality rather than horizontal layers.
</mvp_mode_active>
` : ''}
</planning_context>
