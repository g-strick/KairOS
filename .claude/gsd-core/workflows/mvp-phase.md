...
<required_reading>
@/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/user-story-template.md
@/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/spidr-splitting.md
@/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
