...
INSTALL_JS_GLOBAL="/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/graysonstricker/Programs/KairOS/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
