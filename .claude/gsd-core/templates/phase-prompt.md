...
<!-- For checkpoint task examples and patterns, see @/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
