...
- Usage: Reference from command with `@/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/graysonstricker/Programs/KairOS/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/graysonstricker/Programs/KairOS/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
