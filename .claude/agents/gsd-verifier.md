...
<required_reading>
@/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/verification-overrides.md
...
@/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/few-shot-examples/verifier.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/verify-mvp-mode.md`.
