...
<reference>
@/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/references/user-profiling.md` to load:
