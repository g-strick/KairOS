...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/graysonstricker/Programs/KairOS/.claude/.gsd-surface.json`
(sibling to `/Users/graysonstricker/Programs/KairOS/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/graysonstricker/Programs/KairOS/.claude/skills/gsd-*/`.
...
(`/Users/graysonstricker/Programs/KairOS/.claude`), NOT the skills sub-directory (`/Users/graysonstricker/Programs/KairOS/.claude/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/Users/graysonstricker/Programs/KairOS/.claude` as `configDir`. The skill dirs themselves live at
`/Users/graysonstricker/Programs/KairOS/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Claude Code — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/Users/graysonstricker/Programs/KairOS/.claude}"
SCOPE="global"
...
(i.e. `/Users/graysonstricker/Programs/KairOS/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/graysonstricker/Programs/KairOS/.claude/.gsd-surface.json`
Install profile marker: `/Users/graysonstricker/Programs/KairOS/.claude/.gsd-profile`
Skill dirs: `/Users/graysonstricker/Programs/KairOS/.claude/skills/gsd-*/`
Engine module: `/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/graysonstricker/Programs/KairOS/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
